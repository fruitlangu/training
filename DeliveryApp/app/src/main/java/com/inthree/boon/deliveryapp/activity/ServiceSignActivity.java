...
public class ServiceSignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.service_signature);
...
//        directory = file_path + "/DeliveryApp/";
        directory = file_path + "/ServiceSignApp/";
...
//        file_path = String.valueOf(this.getFilesDir()) + "/DeliveryApp/" + storedPath;
        file_path = String.valueOf(this.getFilesDir()) + "/ServiceSignApp/" + storedPath;
...
//                    isStoragePermissionGranted();
                    if (checkPermission()) {
                        ...
                        if(saveError) {
                            ...
                            Utils.AlertDialogCancel(ServiceSignActivity.this,getResources().getString(R.string.sign_error),getResources().getString(R.string.sign_erst),getResources().getString(R.string.ok),getResources().getString(R.string.cancel_label));
...
//                Log.v("log_tag", "Panel Canceled");
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ServiceSignActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(ServiceSignActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(ServiceSignActivity.this, "Write External Storage permission allows us to do store images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(ServiceSignActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        }
    }
