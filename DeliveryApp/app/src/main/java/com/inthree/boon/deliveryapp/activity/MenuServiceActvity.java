...
import com.inthree.boon.deliveryapp.adapter.ServiceAdapter;
...
public class MenuServiceActvity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderStatus=status.getStringExtra("status");
            ...
            tabLayout.addTab(tabLayout.newTab().setText(R.string.servicepending));
            tabLayout.addTab(tabLayout.newTab().setText(R.string.servicecomplete));
            tabLayout.addTab(tabLayout.newTab().setText(R.string.serviceuncomplete));
        ...
        if(orderStatus!=null) {
            ...
            } else if (orderStatus.equals("incomplete")) {
