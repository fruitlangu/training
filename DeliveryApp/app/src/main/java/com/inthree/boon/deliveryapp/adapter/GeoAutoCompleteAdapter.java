...
/**
 * This is the class of get the automated textview of which user select the location
 */
public class GeoAutoCompleteAdapter extends RecyclerView.Adapter<GeoAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public GeoAutoCompleteAdapter(Context context, int resource, GoogleApiClient googleApiClient,
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            while (iterator.hasNext()) {
                ...
                Toast.makeText(mContext,  prediction.getFullText(null),Toast.LENGTH_SHORT).show();
            }
